...
exports.updateItemById = exports.setUser = exports.setDashboardData = exports.removeItemById = exports.default = exports.dashboardSlice = exports.appendNewItem = void 0;
...
const dashboardSlice = exports.dashboardSlice = (0, _toolkit.createSlice)({
  name: "dashboard",
  initialState,
  reducers: {
    ...
    updateItemById: (state, action) => {
      ...
      // Handle sections under 'resume'
        ...
        console.error("Section ".concat(section, " not found in state for update"));
      }
    },
    ...
    appendNewItem: (state, action) => {
      ...
      // Handle sections under 'resume'
        ...
        console.error("Section ".concat(section, " not found in state"));
      }
    },
    ...
    removeItemById: (state, action) => {
      ...
      // Handle sections under 'resume'
        ...
        console.error("Section ".concat(section, " not found in state for removal"));
      }
    }
  }
});
...
exports.appendNewItem = appendNewItem;
exports.updateItemById = updateItemById;
exports.setDashboardData = setDashboardData;
exports.setUser = setUser;
var _default = exports.default = dashboardSlice.reducer;